 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCQxWCemJpiYz1AVC7zR1Emd8VRA4JnA3o"></script>
    <script>
        function initMap() {
            ...
            var start = new google.maps.LatLng(<?php echo $latitudes[0] ?>, <?php echo $longitudes[0]?>);
            var end = new google.maps.LatLng(<?php echo $latitudes1[0] ?>, <?php echo $longitudes1[0]?>); // substituir por coordenadas reais de partida e destino
            var request = {
                origin: start,
                destination: end,
